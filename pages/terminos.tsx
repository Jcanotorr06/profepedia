...
const Terminos:NextPage = () => {
  ...
  return (
    <>
      <Head>
        <title>{intl.formatMessage({id: 'terms_of_use'})} | Profepedia</title>
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <main className="w-full min-h-full flex flex-col gap-5">
        <h1 className="text-3xl font-medium">Website Terms of Use</h1>
        <article className="surface px-6 py-8 rounded-lg shadow-md text-xs md:text-sm lg:text-base">
          <p>Version 1.0</p>

          <p>The Profepedia website located at www.profepedia.xyz is a copyrighted work belonging to Profepedia. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
          ...
          <p><strong>Cookies and Web Beacons.</strong> Like any other website, Profepedia uses ‘cookies’. These cookies are used to store information including visitors’ preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users’ experience by customizing our web page content based on visitors’ browser type and/or other information.</p>
          ...
          <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.  A Notice to the Company should be sent to: Panama, Panama. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.  If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.  The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
          ...
          <p>Address: Panama, Panama</p>
          <p>Email: myprofepedia@gmail.com</p>
        </article>
      </main>
    </>
  )
