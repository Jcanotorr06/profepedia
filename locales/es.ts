const messages = {
    ...
    "login": "Acceder",
    "kofi_message": "Ayúdanos a mantener esta página online 🥰",
    ...
    "invalid_email": "Dirección de correo inválida. Debes utilizar un correo \"@utp.ac.pa\"",
    ...
    "login_email_ph": "Dirección de correo universitario",
    "login_success_title": "Link de Autenticación Enviado Exitosamente",
    "login_success_message": "Revisa tu correo electrónico y haz clic en el link que te envíamos para iniciar sesión.",
    ...
    "get_ready_to_read": "Prepárate Para Leer",
    "participation_matters": "La Participación Importa",
    "extra_credit": "Créditos Extra",
    ...
    "search_results": "Resultados de búsqueda: {query}",
    ...
    "review_course_description": "Selecciona la materia | salón que tomaste con este profesor(a).",
    "review_remote_question": "¿Tomaste esta clase en modalidad virtual o presencial?",
    "online": "Online",
    "in_person": "Presencial",
    "review_grade_question": "¿Qué promedio recibiste en esta clase?",
    "review_grade_placeholder": "Selecciona el promedio obtenido",
    
    "review_now": "Ahora, califica al profesor.",
    "review_rating_question": "En una escala del 1 al 5, ¿Cómo calificarías a este profesor(a)?",
    "review_difficulty_question": "En una escala del 1 al 5, ¿Qué tan difíciles fueron las clases de este profesor(a)?",
    "review_tags_question": "Escoje hasta 3 etiquetas que mejor describan a este profesor(a)",
    
    "review_next": "Por último, tus opiniones.",
    "review_review_question": "Cuéntanos acerca de tu experiencia con este profesor(a).",
    ...
    "review_terms_and_conditions": "Haz clic aquí para indicar que haz leído y aceptas nuestros {link}.",
    ...
    "landing_title": "Encuentra tu Profesor Y Comparte tu Opinión",
    "landing_description": "Cuéntanos acerca de tus experiencias con los profesores y ayuda a otros estudiantes a tomar la mejor decisión.",
    "loading": "Cargando",
    ...
    "landing_card_paragraph_1": "{bold} es una plataforma abierta a todo el público, pero solo los estudiantes tienen permitido compartir sus experiencias acerca de los profesores. Accede con tu correo institucional para empezar a compartir.",
    "landing_card_title_2": "Encuentra a tu profesor",
    "landing_card_paragraph_2": "Busca en nuestra base de datos entre más de 1,700 profesores, la cual actualizamos cada semestre para poder brindar un mejor servicio a nuevos estudiantes.",
    "landing_card_title_3": "Comparte tu opinión anónimamente",
    "landing_card_paragraph_3": "Sabemos que hablar públicamente acerca de tus profesores puede ser aterrador, por eso en {bold}, decidimos mantener las identidades de los estudiantes 100% anónimas. De esta manera, nos aseguramos de que todos puedan opinar sin pelos en la lengua.",
    ...
    "student_question_1": "¿Cuál es el propósito de esta página?",
    ...
    "student_answer_2": `Las reseñas solo pueden ser realizadas por usuarios con direcciones de correo electrónico universitarios. Creemos que las únicas dos partes con un conocimiento profundo de cómo funciona la clase son el estudiante y el profesor.{br}
    ...
    "student_question_7": "Uno de mis comentarios fue eliminado. ¿Qué comentarios son bienvenidos en la plataforma?",
    "student_answer_7": `Los comentarios deben ser objetivos y específicos. Recuerde, su audiencia es alguien que entra a la clase por primera vez. ¿Qué desearías que alguien te hubiera dicho de antemano que te hubiera dado una ventaja?{br}
    ...
    "faq_paragraph_3": "Por favor dirigase a la {contact} y envíenos un mensaje. Tome en cuenta que, aún si leemos cada pregunta y comentario enviado, no podemos garantizar que recibirá una respuesta.",
